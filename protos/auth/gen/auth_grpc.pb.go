...
type AuthServiceClient interface {
	...
	IsValid(ctx context.Context, in *ValidRequest, opts ...grpc.CallOption) (*ValidResponse, error)
}
...
func (c *authServiceClient) IsValid(ctx context.Context, in *ValidRequest, opts ...grpc.CallOption) (*ValidResponse, error) {
	out := new(ValidResponse)
	err := c.cc.Invoke(ctx, "/proto.AuthService/IsValid", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	IsValid(context.Context, *ValidRequest) (*ValidResponse, error)
...
func (UnimplementedAuthServiceServer) IsValid(context.Context, *ValidRequest) (*ValidResponse, error) {
...
func _AuthService_IsValid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/IsValid",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).IsValid(ctx, req.(*ValidRequest))
	}
	return interceptor(ctx, in, info, handler)
}
